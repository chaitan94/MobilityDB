add_test(
	...
	COMMAND ${PROJECT_SOURCE_DIR}/test/scripts/test.sh run_passfail ${CMAKE_BINARY_DIR} load_geom_tables "../geometry/test/scripts/load.sql.xz"
)
...
file(GLOB geom_testfiles "geometry/test/queries/*.sql")
