...
SELECT tgeography 'Polygon((0 0, 1 0, 1 1, 0 1, 0 0))@2012-01-01 08:00:00';
...
SELECT tgeompointi(ARRAY[tgeompoint 'SRID=5676;Polygon((0 0, 1 0, 1 1, 0 1, 0 0))@2001-01-01', 'SRID=4326;Polygon((0 0, 2 0, 2 2, 0 2, 0 0))@2001-01-02']);
SELECT tgeompointi(ARRAY[tgeompoint 'Polygon((0 0, 1 0, 1 1, 0 1, 0 0))@2001-01-01', 'Polygon((0 0, 2 0, 2 2, 0 2, 0 0))@2001-01-02']);
