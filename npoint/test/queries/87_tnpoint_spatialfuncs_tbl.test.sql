...
SELECT count(*) FROM tbl_tnpoint t1, tbl_geometry t2 WHERE nearestApproachDistance(t1.temp, t2.g) IS NOT NULL;
SELECT count(*) FROM tbl_geometry t1, tbl_tnpoint t2 WHERE nearestApproachDistance(t1.g, t2.temp) IS NOT NULL;
...
SELECT count(*) FROM tbl_tnpoint t1, tbl_geometry t2 WHERE shortestLine(t1.temp, t2.g) IS NOT NULL;
SELECT count(*) FROM tbl_geometry t1, tbl_tnpoint t2 WHERE shortestLine(t1.g, t2.temp) IS NOT NULL;
